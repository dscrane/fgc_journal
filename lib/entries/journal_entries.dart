...
const Map<Entry, Map<String, dynamic>> journalEntries = {
  ...
  Entry.lifeInsuranceAndHoldings: {
    'key': Entry.lifeInsuranceAndHoldings,
    'title': 'Life Insurance and Holdings',
